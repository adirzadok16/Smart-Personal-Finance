            ...
            <div className="flex justify-between items-center gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col">
                        <p className="font-semibold text-white group-hover:text-blue-400 transition-colors">Salary</p>
                        <p className="text-xs text-gray-400">Income • Jan 20, 2026</p>
                    </div>
                </div>
                <div>
                    <p className="text-lg font-bold text-green-500">+5,000.00</p>
                </div>
            </div>
        </div>
    )
